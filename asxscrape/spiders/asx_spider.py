...
class AsxSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        companies = ["AGL", "ALL", "AM8", "AMC", "AMP", "AN8", "ANN", "ANZ", "AP8", "APA", "AR8", "ASX", "AWC", "AZJ", "BEN", "BH8", "BHP", "BLD", "BOQ", "BSL", "BX8", "BXB", "CB8", "CBA", "CCL", "CIM", "CPU", "CS8", "CSL", "CSR", "CTX", "CU8", "CWN", "CYB", "DX8", "FLT", "FM8", "FMG", "GM8", "GMG", "GP8", "GPT", "HVN", "IA8", "IAG", "IFL", "IL8", "ILU", "IPL", "JH8", "JHX", "LL8", "LLC", "MG8", "MGR", "MPL", "MQ8", "MQG", "MTS", "MYR", "NA8", "NAB", "NC8", "NCM", "OI8", "OR8", "ORG", "ORI", "OS8", "OSH", "OZL", "QA8", "QAN", "QBE", "RH8", "RHC", "RI8", "RIO", "RRL", "S32", "SC8", "SCG", "SEK", "SG8", "SGM", "SGP", "SGR", "SHL", "ST8", "STO", "STW", "SUN", "SY8", "SYD", "TAH", "TC8", "TCL", "TL8", "TLS", "TW8", "TWE", "VC8", "VCX", "WB8", "WBC", "WES", "WO8", "WOR", "WOW", "WPL", "XJO"]
